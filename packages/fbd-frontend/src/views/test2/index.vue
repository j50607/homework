<template>
  ...
  >
    ...
    <d-tabs
      ...
      :class="locale"
      @change="changeTab"
      class="game-tab text-white h-full"
      v-if="!state.switchLeague"
    >
      <template #content>
        <league-list
    ...
    >
      ...
      <div class="select-option flex justify-center fixed w-full left-0 h-8">
        <div
          class="select-aciton mr-3 w-2/5 flex py-1 justify-center text-xs is-btn items-center mt-auto"
          @click="selectAll"
        >
          <img
        ...
        <div
          class="select-aciton w-2/5 flex py-1 justify-center text-xs is-btn items-center mt-auto"
          @click="invertSelect()"
        >
          <img
...
import LeagueList from '@/components/_pages/match/leagueList/leagueListTest';
...
::v-deep(.d-tabs-mobile) {
  justify-content: flex-start;
  height: 100%;
}

::v-deep(.d-tabs-mobile) .d-tabs-mobile-area {
  height: 37px;
}

::v-deep(.d-tabs-mobile-content) {
