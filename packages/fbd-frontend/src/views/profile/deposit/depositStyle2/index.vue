      ...
      <div class="deposit-info">
        ...
        <div class="card">
          ...
          <div class="wallet-address">
            ...
            <img
              :src="require('@/assets/img/icon/style2/copy.svg')"
              alt="copy"
              class="copy is-btn"
          ...
          >
            ...
            >
              ...
              <div v-else>
                <img
                  class="upload-icon"
                  :src="require('@/assets/img/icon/style2/upload.svg')"
                >
        ...
        <div class="mt-3">
          ...
          <ul class="mt-1 text-xs text-normal">
            ...
            <li class="hint-item">
              ...
              <span class="actual-amount">{{ getActualAmount }}</span>
            </li>
            <li class="hint-item">
...
.wallet-address {
  ...
  @apply flex items-center px-8 py-2 mt-3;
...
.card {
  ...
  @apply pb-3 mx-3 overflow-hidden;
}
