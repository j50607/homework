import {
  ref, watch, reactive, nextTick, defineComponent,
} from 'vue';
...
export default defineComponent({
  ...
  props: {
    ...
    // 是否使用客製 class .van-pull-refresh__custom，目前用來添加上拉加載下拉刷新需要用到的樣式
  ...
  setup(props, { emit, slots }) {
    ...
    const customClassList = () => props.useCustomClass ? 'van-pull-refresh__custom' : '';
    ...
    return () => {
      ...
      return (
        <div ref={root} class={[bem(), customClassList()]}>
          <div
            class={bem('track')}
            style={trackStyle}
