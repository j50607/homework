...
export default {
  setup() {
    ...
    const renderDate = (date) => dayjs(date).format('YYYY-MM-DD');
...
.betting {
  ...
  &-info-text {
    ...
    &-em {
      @apply font-bold text-normal text-sm;
    }
  ...
  &-main {
    @apply relative flex-1 p-3 pt-7 rounded-t-10;
  ...
  &-item {
    @apply relative flex items-center justify-between mb-2 rounded-3 bg-primary;

    padding: 4.5px 40px 4.5px 38px;
  ...
  &-tab {
    @apply absolute -top-0.5 left-1/2 flex;
  ...
  &-tab-item {
    @apply relative flex-1 text-center;
