<template>
  <div class="return-record">
    ...
    >
      <div class="record">
        <div class="head bg-secondary text-xs flex items-center py-1 fixed w-full h-6 left-0 px-3">
          <p class="w-1/2">
        ...
        <div class="record-container pt-6">
          <div
            class="record-list text-xs flex px-3 py-2"
    ...
    <div
      class="no-data text-center my-11"
      v-else
    >
      <img
