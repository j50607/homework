...
const lang = {
  ...
  views_profile_team: 'Báo cáo nhóm',
  ...
  components_pages_profile_team_confirm: 'Xác nhận',
  components_pages_profile_team_user: '用户',
  components_pages_profile_team_status: 'Trạng thái',
  components_pages_profile_team_time: 'Thời gian',
  components_pages_profile_team_amount: '金额',
  components_pages_profile_team_emptyMessage: '查无相关记录',
  components_pages_profile_team_filterPopup_title: 'Tùy chọn',
  components_pages_profile_team_filterPopup_status1: 'Chưa kết toán',
  components_pages_profile_team_filterPopup_status2: 'Đã kết toán',
  components_pages_profile_team_filterPopup_status3: 'Đã hủy đơn',
  components_pages_profile_team_filterPopup_status4: 'Ván hoà',
  components_pages_profile_team_filterPopup_type: '类型',
  components_pages_profile_team_all: 'Toàn bộ',
  components_pages_profile_team_deposit: 'Nạp tiền',
  components_pages_profile_team_withdraw: 'Rút tiền',
  components_pages_profile_team_today: 'Hôm nay',
  components_pages_profile_team_yesterday: 'hôm qua',
  components_pages_profile_team_week: 'trong 7 ngày',
  ...
  components_pages_profile_team_item: 'Tên dự án',
  components_pages_profile_team_betNo: 'số thứ tự',
  components_pages_profile_team_betOption: 'Tùy chọn đặt cược',
  components_pages_profile_team_gameTime: '开赛时间',
  components_pages_profile_team_gameDetail: 'Chi tiết sự kiện',
  components_pages_profile_team_gameResult: 'kết quả thi đấu',
  components_pages_profile_team_bettingType1: 'toàn trận',
  components_pages_profile_team_bettingType2: 'nửa trận',
  components_pages_profile_team_action1: 'Mở rộng chi tiết',
  components_pages_profile_team_action2: 'Chi tiết thu về',
