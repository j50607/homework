...
const lang = {
  ...
  views_profile_teamReport_confirm: 'Xác nhận',
  views_profile_teamReport_user: '用户',
  views_profile_teamReport_status: 'Trạng thái',
  views_profile_teamReport_time: 'Thời gian',
  views_profile_teamReport_amount: '金额',
  views_profile_teamReport_emptyMessage: '查无相关记录',
  views_profile_teamReport_filterPopup_title: 'Tùy chọn',
  views_profile_teamReport_filterPopup_status1: 'Chưa kết toán',
  views_profile_teamReport_filterPopup_status2: 'Đã kết toán',
  views_profile_teamReport_filterPopup_status3: 'Đã hủy đơn',
  views_profile_teamReport_filterPopup_status4: 'Ván hoà',
  views_profile_teamReport_filterPopup_type: '类型',
  views_profile_teamReport_all: 'Toàn bộ',
  views_profile_teamReport_deposit: 'Nạp tiền',
  views_profile_teamReport_withdraw: 'Rút tiền',
  views_profile_teamReport_today: 'Hôm nay',
  views_profile_teamReport_yesterday: 'hôm qua',
  views_profile_teamReport_week: 'trong 7 ngày',
  views_profile_teamReport_withdrawAuditing: '提现审核中',
  views_profile_teamReport_withdrawSuccess: '提现成功',
  views_profile_teamReport_withdrawCancel: '提现取消',
  views_profile_teamReport_withdrawFail: '提现失败',
  views_profile_teamReport_depositAuditing: '充值审核中',
  views_profile_teamReport_depositSuccess: '充值成功',
  views_profile_teamReport_depositFail: '充值失败',
  views_profile_teamReport_item: 'Tên dự án',
  views_profile_teamReport_betNo: 'số thứ tự',
  views_profile_teamReport_betOption: 'Tùy chọn đặt cược',
  views_profile_teamReport_gameTime: '开赛时间',
  views_profile_teamReport_gameDetail: 'Chi tiết sự kiện',
  views_profile_teamReport_gameResult: 'kết quả thi đấu',
  views_profile_teamReport_bettingType1: 'toàn trận',
  views_profile_teamReport_bettingType2: 'nửa trận',
  views_profile_teamReport_action1: 'Mở rộng chi tiết',
  views_profile_teamReport_action2: 'Chi tiết thu về',
