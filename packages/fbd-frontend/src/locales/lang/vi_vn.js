...
const lang = {
  ...
  views_profile_userinfo_noWallet: 'Khi nạp rút túi tiền cần cài đặt mật khẩu, hiện tại bạn chưa liên kết túi tiền。',
  ...
  views_finance_popup_user_deposit: 'Lịch sử nạp',
  views_finance_popup_user_withdraw: 'Lịch sử rút',
  views_finance_popup_event_gift: 'Quà từ hoạt động',
  views_finance_popup_return_water_record: 'Lịch sử tiền thưởng',
  views_finance_popup_rebate_record: 'Lịch sử tiền thưởng hoa hồng',
  views_finance_popup_poundage: 'Phí thủ tục',
  views_finance_popup_wallet_account_change: 'Chuyển ví',
  views_finance_popup_transfer_record: 'Lịch sử chuyển khoản',
  views_finance_popup_other: 'khác',
  views_profile_wallet_addSuccess: 'Túi tiền đã cập nhật mới thành công',
  views_finance: 'Chi tiết kết toán',
  views_finance_balance: 'Số dư',
  views_profile_transfer_title: '会员互转',
  views_profile_transfer_tabList_subTransfer: 'Cấp dưới chuyển khoản',
  views_profile_transfer_tabList_superiorTransfer: 'Cấp trên chuyển khoản',
  views_profile_transfer_input_placeholder: '输入会员账号搜寻',
  views_profile_transfer_table_title_account: 'Tài khoản',
  views_profile_transfer_table_title_Superioraccount: 'Thêm mới thành viên',
  views_profile_transfer_table_title_money: '金额',
  views_profile_transfer_noWithdrawCode: 'Chưa có túi tiền bắt buộc \n Trong trang thưởng chuyển qua túi liên kết',
  ...
  components_pages_loginAndRegister_loginRegister_register_line_placeholder: 'vui lòng nhập vào mã Line',
  components_pages_loginAndRegister_loginRegister_register_zalo: 'Zalo',
  components_pages_loginAndRegister_loginRegister_register_zalo_placeholder: 'vui lòng nhập vào mã Zalo',
  components_pages_loginAndRegister_loginRegister_register_birthday: 'birthday',
  components_pages_loginAndRegister_loginRegister_register_birthday_placeholder: 'vui lòng nhập vào mã birthday',
  components_pages_loginAndRegister_loginRegister_register_gender: 'gender',
  components_pages_loginAndRegister_loginRegister_register_gender_placeholder: 'vui lòng nhập vào mã gender',
  ...
  components_datepicker_dateRange: 'Thời gian bắt đầu không lớn hơn thời gian kết',
  ...
  components_transferDialog_transfer_remark_placeholder: 'Vui lòng điền nội dung chuyển khoản',
  ...
  components_transferDialog_transfer_amount_biggerThanBalance: 'Số tiền chuyển khoản không thể lớn hơn số dư hiện có',
  components_withdrawCodeDialog_title: 'Xác nhận mật khẩu',
  components_withdrawCodeDialog_inputCode: 'Vui lòng nhập mật khẩu rút tiền tệ',
  components_withdrawCodeDialog_inputCode2: 'Vui lòng nhập mật khẩu rút tiền tệ  tiếp tục giao dịch',
  components_withdrawCodeDialog_forgetPassword: 'Bạn đã quên mật khẩu',
