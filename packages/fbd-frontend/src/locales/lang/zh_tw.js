...
const lang = {
  ...
  views_profile_teamReport: '團隊報表',
  views_profile_teamReport_confirm: '確認',
  views_profile_teamReport_user: '用戶',
  views_profile_teamReport_status: '狀態',
  views_profile_teamReport_time: '時間',
  views_profile_teamReport_amount: '金額',
  views_profile_teamReport_emptyMessage: '查無相關記錄',
  views_profile_teamReport_filterPopup_title: '篩選',
  views_profile_teamReport_filterPopup_status1: '未結算',
  views_profile_teamReport_filterPopup_status2: '已結算',
  views_profile_teamReport_filterPopup_status3: '已撤單',
  views_profile_teamReport_filterPopup_status4: '和局',
  views_profile_teamReport_filterPopup_type: '類型',
  views_profile_teamReport_all: '全部',
  views_profile_teamReport_deposit: '充值',
  views_profile_teamReport_withdraw: '提現',
  views_profile_teamReport_today: '今日',
  views_profile_teamReport_yesterday: '昨日',
  views_profile_teamReport_week: '一周內',
  views_profile_teamReport_withdrawAuditing: '提現審核中',
  views_profile_teamReport_withdrawSuccess: '提現成功',
  views_profile_teamReport_withdrawCancel: '提現取消',
  views_profile_teamReport_withdrawFail: '提現失败',
  views_profile_teamReport_depositAuditing: '充值審核中',
  views_profile_teamReport_depositSuccess: '充值成功',
  views_profile_teamReport_depositFail: '充值失敗',
  views_profile_teamReport_item: '項目',
  views_profile_teamReport_betNo: '訂單編號',
  views_profile_teamReport_betOption: '下單選項',
  views_profile_teamReport_gameTime: '開賽時間',
  views_profile_teamReport_gameDetail: '賽事詳情',
  views_profile_teamReport__gameResult: '賽事結果',
  views_profile_teamReport_bettingType1: '全場',
  views_profile_teamReport_bettingType2: '半場',
  views_profile_teamReport_action1: '展開詳情',
  views_profile_teamReport_action2: '收回詳情',
