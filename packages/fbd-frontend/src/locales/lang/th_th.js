...
const lang = {
  ...
  views_profile_teamReport_confirm: '确认',
  views_profile_teamReport_user: '用户',
  views_profile_teamReport_status: '状态',
  views_profile_teamReport_time: '时间',
  views_profile_teamReport_amount: '金额',
  views_profile_teamReport_emptyMessage: '查无相关记录',
  views_profile_teamReport_filterPopup_title: '筛选',
  views_profile_teamReport_filterPopup_status1: '未结算',
  views_profile_teamReport_filterPopup_status2: '已结算',
  views_profile_teamReport_filterPopup_status3: '已撤单',
  views_profile_teamReport_filterPopup_status4: '和局',
  views_profile_teamReport_filterPopup_type: '类型',
  views_profile_teamReport_all: '全部',
  views_profile_teamReport_deposit: '充值',
  views_profile_teamReport_withdraw: '提现',
  views_profile_teamReport_today: '今日',
  views_profile_teamReport_yesterday: '昨日',
  views_profile_teamReport_week: '一周內',
  ...
  views_profile_teamReport_item: '项目',
  views_profile_teamReport_betNo: '订单号',
  views_profile_teamReport_betOption: '下单选项',
  views_profile_teamReport_gameTime: '开赛时间',
  views_profile_teamReport_gameDetail: '赛事详情',
  views_profile_teamReport__gameResult: '赛事结果',
  views_profile_teamReport_bettingType1: '全场',
