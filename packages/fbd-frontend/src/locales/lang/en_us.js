...
const lang = {
  ...
  views_profile_teamReport_amount: 'amount',
  views_profile_teamReport_emptyMessage: '查无相关记录',
  views_profile_teamReport_filterPopup_title: 'Filter',
  views_profile_teamReport_filterPopup_status1: 'Not Settled',
  views_profile_teamReport_filterPopup_status2: 'Settled',
  views_profile_teamReport_filterPopup_status3: 'Order canceled',
  ...
  views_profile_teamReport_yesterday: 'Tomorrow',
  ...
  views_profile_teamReport_item: 'items',
  views_profile_teamReport_betNo: 'Order number',
  views_profile_teamReport_betOption: 'Betting Options',
  views_profile_teamReport_gameTime: '开赛时间',
  views_profile_teamReport_gameDetail: 'game details',
  views_profile_teamReport_gameResult: 'Match Results',
  views_profile_teamReport_bettingType1: 'Full-court',
  views_profile_teamReport_bettingType2: 'Half-court',
  views_profile_teamReport_action1: 'Show more details',
  views_profile_teamReport_action2: 'Show fewer details',
