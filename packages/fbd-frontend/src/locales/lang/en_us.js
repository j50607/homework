...
const lang = {
  ...
  views_betRecord_sum_label2: 'Settled Races : ',
  views_betRecord_sum_label3: 'Unsettled Races : ',
  ...
  views_profile_title: 'My',
  views_profile_balance: 'Balance',
  views_profile_lockWallet: 'Lock my Wallet',
  views_profile_goDeposit: 'Make a Recharge',
  views_profile_goWithdraw: 'Make a Cash Withdrawal Now',
  views_profile_transactionRecord: 'Recharge and Cash Withdrawal Records',
  views_profile_walletManagement: 'Wallet Management',
  ...
  views_match_tablist_all: 'All Races',
  views_match_tablist_today: 'Today’s Races',
  views_match_tablist_tomorrow: 'Tomorrow’s Races',
  views_match_tablist_record: 'History Matches',
  ...
  views_market_allLeague_deadLine: 'The betting period ended',
  ...
  views_profile_depositAmount: 'Recharge Amount',
  views_profile_handlingFee: 'Fees',
  views_profile_promotionAmount: 'Special Offer',
  ...
  views_home_matchNews: 'Race News',
  views_home_matchHot: 'Popular Races',
  ...
  views_profile_wallet_placeholder2: 'Please enter the cash withdrawal address for your virtual currency',
  ...
  views_profile_userinfo_setPhone_pleaseEnterVerifyPhoneNumber: 'Please enter your mobile verification code',
  views_profile_userinfo_setPhone_sendVerifyNumber: 'Send the verification code',
  ...
  views_profile_transaction_withdraw: 'Cash Withdrawal',
  ...
  views_profile_transaction_handlingFee: 'Fees',
  ...
  components_pages_match_record_full_and_half: 'Full-court / Half-court',
  components_pages_match_record_dialog_title: 'Race Results',
  components_pages_match_noData: 'No race for now',
  components_pages_profile_transaction: 'Recharge and Cash Withdrawal Records',
  components_footer_home: 'Home Page',
  components_footer_match: 'Market',
  components_footer_record: 'Records',
  components_footer_finance: 'Financial Detail',
  components_footer_profile: 'My',
