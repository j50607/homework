...
const lang = {
  ...
  components_pages_components_vip_detailDailog_description: 'Place  <span class="text-secondary">{betSum}</span> orders within 30 days to stay at level <span class="text-secondary">VIP{level}</span>. Otherwise, your level will be moved down to  <span class="text-secondary">VIP{preLevel}</span>  ',
  components_pages_components_vip_detailDailog_description2: ' {deadLine} days left.  {alreadyBetSum} orders have been placed',
  components_pages_components_vip_detailDailog_description3: 'place <span class="text-secondary">{betSum}</span>  orders within 30 days to get promoted to <span class="text-secondary">VIP{level}</span> level',
  components_pages_components_vip_detailDailog_description4: '{deadLine} day(s) left. {alreadyBetSum} order(s) have been placed.',
  components_pages_components_vip_detailDailog_description5: 'Total deposit amount since you registered, <span class="text-secondary">{betSum}</span> left. You will be able to level up to <span class="text-secondary">VIP{level}</span> 。 ',
  components_pages_components_vip_detailDailog_description6: 'Total order amount since you registered, <span class="text-secondary">{betSum}</span> left. You will be able to level up to <span class="text-secondary">VIP{level}</span> 。',
