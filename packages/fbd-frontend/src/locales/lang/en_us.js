...
const lang = {
  ...
  components_pages_components_vip_detailDailog_description3: 'place <span class="text-color">{betSum}</span>  orders within 30 days to get promoted to <span class="text-color">VIP{level}</span> level',
